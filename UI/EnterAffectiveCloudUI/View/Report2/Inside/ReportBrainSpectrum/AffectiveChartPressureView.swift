...
public class AffectiveChartPressureView: UIView, ChartViewDelegate, UIGestureRecognizerDelegate {
    ...
    func initFunction() {
        ...
        marker?.titleLabel?.text = "Pressure"
    ...
    private func zoomBtnTouchUpInside(sender: UIButton) {
        ...
        if !isZoomed {
            ...
            let chart = AffectiveChartPressureView()
